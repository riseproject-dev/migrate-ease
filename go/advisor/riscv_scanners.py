...
from .riscv_asm_file_scanner import RiscvAsmFileScanner
from .riscv_go_file_scanner import RiscvGoFileScanner
...
class RiscvScanners:
    ...
    def __init__(self, issue_type_config, output_format, march):
        ...
        self.scanners = [RiscvLibScanner(output_format=output_format, march=march),
                         RiscvGoFileScanner(output_format=output_format, march=march),
                         RiscvAsmFileScanner(output_format=output_format, march=march)]
