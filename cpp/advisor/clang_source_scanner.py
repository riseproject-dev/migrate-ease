...
class ClangSourceScanner(CppScanner):
    ...
    #  Maps each supported RISC-V march to its predefined-macro JSON. The JSON
    #  drives #if/#ifdef branch evaluation and is generated by
    #  cpp/db/generate_macros.sh.
    MACROS_JSON = {
        'rv64gc': 'macros_rv64gc.json',
        'rva23': 'macros_rva23.json',
    }
    ...
    def __init__(self, output_format, march, compiler='gcc', warning_level='L1'):
        ...
        if self.march in SUPPORTED_MARCH:
            json_file = self.MACROS_JSON[self.march]
    ...
    def load_checkpoints(self):
        ...
        self.RISCV_INCOMPATIBLE_INTRINSICS = init_checkpoints(
            ...
            self.checkpoints_content['AARCH64_SVE_INTRINSICS'],
    ...
    def set_checkpoints(self):
        self.INCOMPATIBLE_INTRINSICS = self.RISCV_INCOMPATIBLE_INTRINSICS
